                    ...
                    <div class="sale-preview p-4" id="saleReceiptPrintContent">
                        ...
                        <div class="invoice-footer mt-4">
                            ...
                            <div class="border-top pt-3" style="font-size: 0.7rem; line-height: 1.2;">
                                ...
                                <p class="text-center mt-2" style="font-size: 0.65rem; margin-bottom: 0;"><strong>Goods return will be accepted within 10 days only. Electrical and body parts non-returnable.</strong></p>
                            </div>
                        </div>
                    </div>
                </div>
